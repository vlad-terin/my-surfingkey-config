...
,searches = {
    ...
    //map
    'gM': ['구글맵', 'https://www.google.com/maps?q='],
    ...
    //file
    'pdf': ['pdf', googleSearchQ +'filetype%3Apdf+'],
    'cpp': ['cpp', googleSearchQ +'filetype%3Acpp+'],
    'hwp': ['hwp', googleSearchQ +'filetype%3Ahwp+'],
    'ppt': ['ppt', googleSearchQ +'filetype%3Appt+']
}
...
// @todo: create if, else-if chain to create site specific key mappings
